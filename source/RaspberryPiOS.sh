...
if [ -z "$CODENAME" ]; then
    echo "❌ Cannot detect system codename, defaulting to bullseye"
    CODENAME="bullseye"
fi
...
# ----------------------------
# clean conflicting sources
# ----------------------------
echo "🧹 Cleaning conflicting source files..."
...
# ----------------------------
# Raspberry Pi repo (HTTPS + keyring)
# ----------------------------
